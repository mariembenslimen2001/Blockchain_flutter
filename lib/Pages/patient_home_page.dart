...
class _PatientHomePageState extends State<PatientHomePage> {
  ...
  void getPrescriptions() async {
    ...
    // Prescription fetching logic would go here
    setState(() {
      showLoading = false;
    });
  }
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          "Patient Address", // Placeholder for actual address
                          style: TextStyle(
                    ...
                    InkWell(
                      onTap: () {
                        // Log out and navigate to registration page
                            ...
                            await Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => ViewPrescription(
                                        index: index + 1,
                                        record: prescriptions[index]))); // View prescriptions
                          },
                          child: Padding(
